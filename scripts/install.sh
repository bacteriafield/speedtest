...
do_install_appimage() {
    ...
    INSTALL_DIR="${HOME}/.local/share/speedtest-tool"
    BIN_DIR="${HOME}/.local/bin"
    SYMLINK_PATH="${BIN_DIR}/speedtest"
    ...
    ln -sf "$INSTALL_DIR/usr/bin/speedtest" "$SYMLINK_PATH"
...
run_fallbacks() {
    ...
    log_error "Installation failed. No supported native package manager or fallback (appimage/nix/cargo) found."
}
